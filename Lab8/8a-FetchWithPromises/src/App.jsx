...
const App = () => {
  ...
  // Fetch JSONPlaceholder data using Promises
  const fetchPosts = () => {
  ...
  // Fetch OpenWeather data using Promises
  const fetchWeather = () => {
  ...
  return (
    <div className="app">
      <div className="container">
        <h1 className="title">Fetch API with Promises</h1>
        <p className="subtitle">Using .then() and .catch() for API calls</p>
